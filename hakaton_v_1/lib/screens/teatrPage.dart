...
class TeatrPage extends StatefulWidget {
  @override
  _TeatrPageState createState() => _TeatrPageState();
}

class _TeatrPageState extends State<TeatrPage> {
  ...
  void _fetchMusicData() async {
    try {
      musicData = await apiService.getTeatre();
      print(musicData);
